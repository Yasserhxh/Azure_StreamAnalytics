...
namespace ProtobufDeserializer.Devices
{
    public class Codec8E
    {
        private static readonly DateTime AvlEpoch = new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc);
        ...
        private AvlData DecodeAvlData()
        {
            ...
            var dateTime = AvlEpoch.AddMilliseconds(1);
          ...
          //  var ioElement = IoElement.Create(eventId, propertiesCount, ioProperties);
            ...
            return AvlData.Create(priority.ToString(), dateTime, gpsElement, new IoElement());
        }
